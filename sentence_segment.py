...
sentence_data = spark.createDataFrame([(1, "Hi I heard about Spark. I wish Java could use case classes. Logistic regression models are neat"), (2, content)], ["id", "rawDocument"])
